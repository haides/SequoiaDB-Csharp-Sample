...
namespace WindowsFormsApp1
{
	public class Common
	{
		...
		public static void FindRecord(DBCollection dbc, BsonDocument query, BsonDocument selector, BsonDocument orderBy,BsonDocument hint, long skip, long numReturn)
		{
			try
			{
		...
		public static void CreateIndex(DBCollection dbc, string indexName,BsonDocument key, bool isUnique, bool isEnforced)
		{
			try
			{
